...
Ext.define('Shopware.apps.InnocigsArticle.controller.Main', {
    ...
    onImportItems: function(grid) {
        ...
        Ext.Ajax.request({
            method: 'POST',
            url: '{url controller=InnocigsArticle action=import}',
            params: {},
    ...
    onApplyFilter: function(grid) {
        ...
        Ext.Ajax.request({
            method: 'POST',
            url: '{url controller=InnocigsArticle action=filter}',
            params: {},
            callback: function(responseData, operation) {
                mask.hide();
                if(!operation) {
