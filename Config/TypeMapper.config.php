...
return [
    'types' => [
        ...
        TypeMapper::TYPE_EASY4_CAP          => 'EASY4_CAP',
    ...
    'name_type_mapping' => [
        ...
        '~nexM (Chill)|(Turbo)|(Extreme) Set~' => TypeMapper::TYPE_COIL,
        '~PnP Meshed-Cotton Set~'              => TypeMapper::TYPE_COIL,
        '~PnP RBC Set~'                        => TypeMapper::TYPE_COIL,
        '~DIY Wicklungen~'                     => TypeMapper::TYPE_COIL,
        '~JesterX.*Wicklung.*Watte~'           => TypeMapper::TYPE_COIL,
        '~- nexM Clapton S -~'                 => TypeMapper::TYPE_COIL,
        '~Ladestation~'                        => TypeMapper::TYPE_CHARGER,
        '~Drag 3 - E-Zigarette~'               => TypeMapper::TYPE_E_CIGARETTE,
        '~Drag X Plus - E-Zigarette~'           => TypeMapper::TYPE_E_CIGARETTE,
        ...
        '~Easy 4.*Cap~'                        => TypeMapper::TYPE_EASY4_CAP,
